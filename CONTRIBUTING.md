...
> This project uses npm workspaces. Do not use Yarn or pnpm without an explicit migration.
...
```sh
Running "VibeNativeDicomExample" with {"fabric":true,"initialProps":{"concurrentRoot":true},"rootTag":1}
```
...
- `npm test`: run unit tests with [Jest](https://jestjs.io/).
