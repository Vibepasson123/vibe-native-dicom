...
| SR-0012 | [`cpp/dicom_read.h`](../../cpp/dicom_read.h) writeSyntheticDicomFile | [`cpp/dicom_read.cpp`](../../cpp/dicom_read.cpp) writeSyntheticDicomFile; per-platform thin wrappers in iOS/Android impl files | [`example/src/App.tsx`](../../example/src/App.tsx) calls `writeSyntheticDicom()` then `readDicom()`; round-trip succeeds on both platforms. | _n/a_ | In progress |
